# Github User Page Replica

This is a react app developed according to mockup by [Babalola Simeon](https://twitter.com/boasbabs) and bootstrapped with [Create React App](https://github.com/facebook/create-react-app).
